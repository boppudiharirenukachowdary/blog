...
mydb=mysql.connector.connect(host='localhost',user='root',password='system',db='hari')
with mysql.connector.connect(host='localhost',user='root',password='system',db='hari'):
...
def login():
    if request.method=='POST':
        ...
        if data==1:
            ...
            return 'Invalid Username aned password'   
